...
export const setTimeout = (...args: Parameters<setTimeout>) =>
	getWorkerTimer().setTimeout(...args)
...
export const createWorkerTimer = (): WorkerTimer => {
	...
	//
	return {
		setTimeout: (func: TimerHandler, duration: number, ...args: unknown[]) =>
			setTimer('setTimeout', func, duration, ...args),
		setInterval: (func: TimerHandler, duration: number, ...args: unknown[]) =>
			setTimer('setInterval', func, duration, ...args),
